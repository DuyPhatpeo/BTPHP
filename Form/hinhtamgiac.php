...
<head>
    ...
    <style type="text/css">
        ...
        table{
            background: #1e1e1e; /* Nền bảng tối */
            border: 2px solid #4CAF50; /* Đổi màu viền thành xanh lá */
            border-radius: 10px;
            padding: 20px;
            box-shadow: 0 4px 15px rgba(0, 0, 0, 0.6); /* Bóng mờ đậm hơn */
            margin: 50px auto;
        }
        thead{
            background: #4CAF50; /* Đổi màu nền của tiêu đề thành xanh lá */
            color: white;
            border-radius: 10px;
        }
        td {
        ...
        input[type="text"] {
            ...
            background-color: #333; /* Nền input */
            color: #f0f0f0; /* Màu chữ input */
        }
        input[type="submit"] {
            padding: 10px 20px;
            background-color: #4CAF50; /* Đổi màu nút thành xanh lá */
            border: none;
            border-radius: 5px;
            color: white;
            cursor: pointer;
        ...
        input[type="submit"]:hover {
            background-color: #45a049; /* Màu hover cho nút */
        }
        h3{
        ...
        .error {
            color: #ff6666; /* Màu đỏ sáng cho lỗi */
            text-align: center;
            margin-top: 10px;
        }
    </style>
...
<form align='center' action="" method="post">
    <table>
        <thead>
            <th colspan="2" align="center"><h3>TÍNH DIỆN TÍCH VÀ CHU VI TAM GIÁC</h3></th>
        </thead>
        <tr><td>Cạnh a:</td>

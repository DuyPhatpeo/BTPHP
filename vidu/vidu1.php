...
// Đọc dữ liệu từ tệp JSON, nếu tệp tồn tại và không rỗng
if (file_exists($file_path) && filesize($file_path) > 0) {
    $employees = json_decode(file_get_contents($file_path), true);
} else {
    $employees = [];
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['addEmployee'])) {
        ...
        // Xóa dữ liệu trong tệp JSON khi nhấn nút làm mới
        ...
        <form method="POST" action="" class="mt-3">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="maNV" name="maNV"
                    value="<?php echo isset($_POST['maNV']) ? $_POST['maNV'] : ''; ?>">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="gioiTinh" name="gioiTinh"
                    value="<?php echo isset($_POST['gioiTinh']) ? $_POST['gioiTinh'] : ''; ?>"
                    placeholder="Nhập giới tính (Nam, Nữ, Khác)">
            </div>
            <div class="form-group">
                <label for="soDienThoai">Số điện thoại:</label>
                <input type="tel" class="form-control" id="soDienThoai" name="soDienThoai"
                    value="<?php echo isset($_POST['soDienThoai']) ? $_POST['soDienThoai'] : ''; ?>">
            </div>
            <div class="form-group">

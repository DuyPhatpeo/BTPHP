...
<body class="container mt-5">
    <div class="container w-50 mb-4">
        ...
        <form action="" method="post" class="row g-3">
            ...
            <input type="hidden" name="employee_hoTenNV[]"
                value="<?php echo htmlspecialchars($employee['hoTenNV']); ?>">
            <input type="hidden" name="employee_ngaySinh[]"
                value="<?php echo htmlspecialchars($employee['ngaySinh']); ?>">
            <input type="hidden" name="employee_gioiTinh[]"
                value="<?php echo htmlspecialchars($employee['gioiTinh']); ?>">
            <input type="hidden" name="employee_soDienThoai[]"
                value="<?php echo htmlspecialchars($employee['soDienThoai']); ?>">
            <input type="hidden" name="employee_maChucVu[]"
                value="<?php echo htmlspecialchars($employee['maChucVu']); ?>">
            <?php endforeach; ?>
    ...
    <div class="container">
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    <td><?php echo htmlspecialchars($employee['maNV']); ?></td> <!-- Hiển thị mã NV -->
                    <td><?php echo htmlspecialchars($employee['hoTenNV']); ?></td> <!-- Hiển thị họ tên NV -->
                    <td><?php echo htmlspecialchars($employee['ngaySinh']); ?></td> <!-- Hiển thị ngày sinh NV -->
                    <td><?php echo htmlspecialchars($employee['gioiTinh']); ?></td> <!-- Hiển thị giới tính NV -->
                    <td><?php echo htmlspecialchars($employee['soDienThoai']); ?></td>
                    <!-- Hiển thị số điện thoại NV -->
                    <td><?php echo htmlspecialchars($employee['maChucVu']); ?></td> <!-- Hiển thị mã chức vụ NV -->
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
...
chỉnh sửa lại thành thông tin truyên gồm: mã truyện, tên truyện, tên tác giả, số chương là textfield,thể loại combobox,
nội dung tóm tắt là textarea
